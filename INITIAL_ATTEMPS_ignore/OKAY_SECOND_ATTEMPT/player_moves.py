...
from INITIAL_ATTEMPS_ignore.OKAY_SECOND_ATTEMPT.ships_status import Ship
from INITIAL_ATTEMPS_ignore.OKAY_SECOND_ATTEMPT.multiplayer_client import Client
